...
-- 펜션 추가
INSERT INTO TB_STAY VALUES(SEQ_TB_STAY_NO.NEXTVAL, '펜션', '라만차', '/resources/images/stay/stay', '제주 제주시 한림읍 금능6길 16-5', '120,000원', '0507-1428-9030', '금능해수욕장과 2분거리인 팬션에서 바다도 즐기시고 편안한 휴식도 함께 가져보세요.', '33.38860913380529', '126.23187513971205', 14);
INSERT INTO TB_STAY VALUES(SEQ_TB_STAY_NO.NEXTVAL, '펜션', '하모니리조트', '/resources/images/stay/stay', '제주 제주시 한림읍 협재로 213 하모니', '103,000원', '064-796-8441', '깨끗하고 조용한 환경에서 힐링여행을 즐겨보세요.', '33.379353806208684', '126.25208989059495', 14);
...
-- 캠핑 추가
INSERT INTO TB_STAY VALUES(SEQ_TB_STAY_NO.NEXTVAL, '캠핑', '어라운드폴리캠프', '/resources/images/stay/stay', '제주 서귀포시 성산읍 서성일로 431', '140,000원', '0507-1433-7079', '자연친화적인 환경 안에서 캠핑에 입문하는 사람들에 대한 편의성을 높였습니다.', '33.415552415777086', '126.83566763863982', 9);
INSERT INTO TB_STAY VALUES(SEQ_TB_STAY_NO.NEXTVAL, '캠핑', '모구리야영장', '/resources/images/stay/stay', '제주 서귀포시 성산읍 서성일로 260', '5,000원', '064-760-3408', '저렴한 가격으로 가족과 좋은 추억을 보내보세요.', '33.407891382171556', '126.82768924600646', 9);
...
-- 까페 추가
INSERT INTO TB_REST VALUES(SEQ_TB_REST_NO.NEXTVAL, '카페', '니모메빈티지라운지', '때때로맑음 에이드', '/resources/images/rest/rest', '제주 제주시 일주서로 7335-8', '064-742-3008', '7,500원', '없음', '시원한 바다뷰를 보면서 맛있는 에이드 한잔 하세요.', '33.49369173624675', '126.43091504164053', 6);
INSERT INTO TB_REST VALUES(SEQ_TB_REST_NO.NEXTVAL, '카페', '에스프레소 라운지', '카페라떼', '/resources/images/rest/rest', '제주 제주시 한라대학로 1', '0507-1422-5151', '5,000원', '없음', '맛있는 빵과 커피를 먹으며 여운을 즐기세요.', '33.4806392405611', '126.47276170486371', 6);
INSERT INTO TB_REST VALUES(SEQ_TB_REST_NO.NEXTVAL, '카페', '슬로우벗커피로스터스', '핸드드립', '/resources/images/rest/rest', '제주 제주시 흥운길 77-1', '064-722-9082', '6,000원', '매주 월요일', '바다와 용연구름다리 사이의 전망좋은 카페', '33.515517054101416', '126.51405392701167', 6);
...
-- 술집 추가
INSERT INTO TB_REST VALUES(SEQ_TB_REST_NO.NEXTVAL, '술집', '제주맥주', '치킨', '/resources/images/rest/rest', '제주특별자치도 제주시 한림읍 금능농공길 62-11', '064-798-9872', '20,000원', '월, 화, 수, 목', '제주맥주양조장에서 특별한 체험과 맛있는 경험을 해보세요.', '33.358503789378965', '126.24120482665897', 14);
INSERT INTO TB_REST VALUES(SEQ_TB_REST_NO.NEXTVAL, '술집', '맥파이 브루어리', '페일에일', '/resources/images/rest/rest', '제주 제주시 동회천1길 23', '0507-1383-0227', '7,000원', '매주 월요일, 화요일', '맛있는 음식과 맥주 브루어리 투어를 통한 추억을 쌓으세요.', '33.50320222013382', '126.61717088033707', 14);
INSERT INTO TB_REST VALUES(SEQ_TB_REST_NO.NEXTVAL, '술집', '랜돌프비어 제주시청점', '수제맥주', '/resources/images/rest/rest', '제주 제주시 신성로13길 27 2층 랜돌프비어', '064-755-8608', '4,900원', '없음', '다양한 수제생맥주와 뉴욕식 씬페페로니 피자를 즐겨보세요!', '33.497895225348046', '126.53035883897287', 14);
