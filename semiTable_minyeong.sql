...
-- 관광명소
INSERT INTO TB_SPOT VALUES(SEQ_TB_SPOT_NO.NEXTVAL, '우도 일주', '관광명소', '/resources/images/spot/spot', '제주도 제주시 우도면', NULL, NULL, NULL, '제주도에서도 가장 제주도의 모습을 많이 지니고 있어 찾아볼 수 있는 곳은 8개의 유인도 중에서 바로 우도다. 우도는 제주도의 또 다른 속살이라고 불릴 만큼 제주도를 가장 많이 닮았다.', '33.504468693145434', '126.95567048276018', 10);
INSERT INTO TB_SPOT VALUES(SEQ_TB_SPOT_NO.NEXTVAL, '올레길 1코스', '관광명소', '/resources/images/spot/spot', '제주도 서귀포시 성산읍', NULL, NULL, NULL, '1코스는 오름과 해변을 즐기며 성산일출봉을 배경으로 한 광치기해변의 풍경을 가슴 가득하게 담을 수 있는 화려한 올레길이다.', '33.478781428006805', '126.90619206049644', 11);
INSERT INTO TB_SPOT VALUES(SEQ_TB_SPOT_NO.NEXTVAL, '한림에서 일몰 감상', '관광명소', '/resources/images/spot/spot', '제주도 제주시 한림읍', NULL, NULL, NULL, '한림항 방파제 너머로 보이는 장엄한 해넘이의 모습을 감상하세요.', '33.3938062728464', '126.23910861862116', 5);
INSERT INTO TB_SPOT VALUES(SEQ_TB_SPOT_NO.NEXTVAL, '함덕 서우봉', '관광명소', '/resources/images/spot/spot', '제주도 제주시 조천읍 조함해안로 525', NULL, NULL, NULL, '제주시 조천읍 함덕리에 자리한 함덕해수욕장은 해수욕장 바로 옆에 우뚝선 오름(서우봉) 덕분에 ‘함덕서우봉해변’이라고도 불린다. 제주공항에서 불과 20km 떨어졌지만, 이곳에 도착하는 순간 다른 나라에 온 것 같은 기분이 든다.', '33.54463437968791', '126.67279685587532', 8);
INSERT INTO TB_SPOT VALUES(SEQ_TB_SPOT_NO.NEXTVAL, '마라도', '관광명소', '/resources/images/spot/spot', '제주도 서귀포시 대정읍 가파리 600', NULL, NULL, NULL, '마라도는 대한민국 최남단에 위치한 섬이며, 모슬포항에서 11km 정도 떨어져 있다. 면적은 0.3km2, 해안선의 길이는 4.2km이고, 최고점은 39m이다. 인구수는 59가구 127명이다.', '33.118470081316794', '126.26716361294976', 19);
INSERT INTO TB_SPOT VALUES(SEQ_TB_SPOT_NO.NEXTVAL, '김영갑갤러리두모악', '관광명소', '/resources/images/spot/spot', '제주도 서귀포시 성산읍 삼달로 137', '064-784-9907', '성인 4,500원', NULL, '김영갑갤러리두모악 미술관은 우리 모두가 주인입니다. 김영갑 선생님께서 돌아가신 이후에도 많은 분들의 지속적인 관심과 후원으로 김영갑갤러리두모악을 지켜낼 수 있었습니다.', '33.371907836292344', '126.85411975896017', 11);
INSERT INTO TB_SPOT VALUES(SEQ_TB_SPOT_NO.NEXTVAL, '카멜리아힐 동백꽃 축제', '관광명소', '/resources/images/spot/spot', '제주도 서귀포시 안덕면 병악로 166', '064-792-0088', '성인 9,000원', NULL, '카멜리아힐은 30년 열정과 사랑으로 제주의 자연을 담은 동양에서 가장 큰 독백 수목원입니다.', '33.2896334751668', '126.3699987388998', 14);
INSERT INTO TB_SPOT VALUES(SEQ_TB_SPOT_NO.NEXTVAL, '오설록 티 뮤지엄', '관광명소', '/resources/images/spot/spot', '제주도 서귀포시 안덕면 신화역사로 15 오설록', '064-794-5312', NULL, NULL, '제주 오설록 서광 차밭과 맞닿아 있는 오설록 티뮤지엄은 아모레퍼시픽이 차와 한국 전통차 문화를 소개하고, 널리 보급하고자 2001년 9월에 개관한 국내 최초의 차 박물관입니다. 동양과 서양, 전통과 현대가 조화를 이룬 문화공간으로 차 유물관, 자연친화적인 휴식공간, 2013년 티클래스를 더해 21세기형 차 박물관으로 발돋움했습니다.', '33.30592832770181', '126.28943924447807', 14);
INSERT INTO TB_SPOT VALUES(SEQ_TB_SPOT_NO.NEXTVAL, '비자림 숲길 산책', '관광명소', '/resources/images/spot/spot', '제주도 제주시 구좌읍 비자숲길 55', '064-710-7912', '성인 3,000원', NULL, '천연기념물로 지정보호하고 있는 비자림은 448,165㎡의 면적에 500∼800년생 비자나무 2,800여 그루가 밀집하여 자생되고 있다.', '33.49039663908823', '126.80998111906597', 9);
...
-- 체험
INSERT INTO TB_SPOT VALUES(SEQ_TB_SPOT_NO.NEXTVAL, '제주 민속촌 체험', '체험', '/resources/images/spot/spot', '제주도 서귀포시 표선면 민속해안로 631-34', '064-787-4501', '성인 11,000원', NULL, '제주민속촌은 제주의 문화유산을 원형 그대로 보존하기 위해 19세기를 기준 연대로 산촌, 중간산촌, 어촌, 토속신앙을 비롯하여 제주영문과 유배소 등을 전문가의 고증을 통해 구성한 박물관입니다.', '33.32239415820749', '126.84230265692152', 12);
INSERT INTO TB_SPOT VALUES(SEQ_TB_SPOT_NO.NEXTVAL, '김녕 요트 투어', '체험', '/resources/images/spot/spot', '제주도 제주시 구좌읍 구좌해안로 229-16', '064-787-4501', '성인 60,000원', NULL, '한라산 동쪽 수려한 자연경관속 화려한 요트에서 즐기는 제주의 風光은 또다른 인생의 기쁨을 제공합니다.제주도 요트의 마을 제주 김녕!', '33.55825769580114', '126.73723723244173', 9);
INSERT INTO TB_SPOT VALUES(SEQ_TB_SPOT_NO.NEXTVAL, '제주레일바이크', '체험', '/resources/images/spot/spot', '제주도 제주시 구좌읍 용눈이오름로 641', '064-783-0033', '성인 15,000원', NULL, '스릴과 힐링 ! 제주의 대자연을 달리고 체험 할 수 있는 제주레일바이크!', '33.464610778200985', '126.83693323027171', 9);
INSERT INTO TB_SPOT VALUES(SEQ_TB_SPOT_NO.NEXTVAL, '낭만농장 귤밭76번지', '체험', '/resources/images/spot/spot', '제주도 서귀포시 안덕면 병악로 76', '0507-1422-5303', '성인 2,000원', NULL, '낭만농장 귤밭76번지에서 제주 감귤 따기 체험이 가능합니다.', '33.28306081396761', '126.36514557932507', 14);
INSERT INTO TB_SPOT VALUES(SEQ_TB_SPOT_NO.NEXTVAL, '얼라이브 카트', '체험', '/resources/images/spot/spot', '제주도 서귀포시 중문관광로 42', '064-805-0987', '성인 25,000원', NULL, '짜릿한 속도감을 느낄 수 있는 카트레이싱 체험! 최고의 시설과 안전함, 무엇과도 비교할 수 없는 제주의 아름다운 자연속에서 쌓인 스트레스를 한방에 날려버리세요.', '33.25487485151966', '126.40779698229491', 15);
-- 쇼핑
INSERT INTO TB_SPOT VALUES(SEQ_TB_SPOT_NO.NEXTVAL, '아더하프', '쇼핑', '/resources/images/spot/spot', '제주도 제주시 신설로4길 4 1층', '0507-1330-4958', NULL, '매주 월요일', '제주 유일 애견용품 편집샵입니다. 인터넷으로만 구입해야 했던 다양한 브랜드의 애견 용품이 구비되어있습니다.', '33.493719741629874', '126.54210789426187', 7);
INSERT INTO TB_SPOT VALUES(SEQ_TB_SPOT_NO.NEXTVAL, '텐저린 컬쳐스테이션 편집샵', '쇼핑', '/resources/images/spot/spot', '제주도 제주시 관덕로 26', '064-751-9505', NULL, NULL, '국내외 다양한 브랜드와 제주의 브랜드들이 함께 어울리게 되었습니다.', '33.51284760943955', '126.52197434145695', 7);
INSERT INTO TB_SPOT VALUES(SEQ_TB_SPOT_NO.NEXTVAL, '제주 감성 편집샵 제주가 푸르다', '쇼핑', '/resources/images/spot/spot', '제주도 서귀포시 칠십리로 38-1', '064-763-5885', NULL, NULL, '제주 감성 편집샵 제주가 푸르다에서 제주에서만 느낄 수 있는 특별한 오브제를 만나보실 수 있습니다.', '33.24133703688292', '126.56117238220656', 14);
INSERT INTO TB_SPOT VALUES(SEQ_TB_SPOT_NO.NEXTVAL, '서쪽가게', '쇼핑', '/resources/images/spot/spot', '제주 제주시 한림읍 한림로 372-7', '064-796-8178', NULL, NULL, '환경은 더 이상 선택이 아닌 필수가 되야 한다고 생각한 저희는 더 이상 지구가 아프지 않았으면 좋겠다는 바람으로 샵의 철학을 정리하는 시간을 가졌어요', '33.39566798622275', '126.24389155539822', 5);
INSERT INTO TB_SPOT VALUES(SEQ_TB_SPOT_NO.NEXTVAL, '아코제주', '쇼핑', '/resources/images/spot/spot', '제주 제주시 구좌읍 구좌로 75-1', '070-8869-2177', NULL, NULL, '아코제주에서 제주를 연상케 하는 소품들을 준비했습니다. 다양한 소품을 통해 제주를 느껴보세요.', '33.521506314642444', '126.85880724374273', 9);
